...
- [x] 01-02-PLAN.md — Whole-chain PKI verification, root export and trust docs, secrets guard, dogfooding findings log (wave 2)
- [x] 01-04-PLAN.md — AuthZ catalog, per-tenant admin, signing CAs, service credentials, resource tree and group pattern (wave 2)
- [x] 01-05-PLAN.md — Device Twin RabbitMQ auth backend: full four-endpoint contract with offline test suite (wave 2)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — Caddy single origin, AXIAM console host, landing page, PostgreSQL (wave 3)
- [x] 01-06-PLAN.md — Smoke: live authorization assertions and the positive/negative device connect matrix (wave 3)
